...
, un corrispondente numero di macchina \(fl(x) \in \mathcal{M}\). 
...
\includegraphics[width=\textwidth]{esercizio21_1.png}
\includegraphics[width=\textwidth]{esercizio21_2.png}
\includegraphics[width=\linewidth]{esercizio21_3.png}
\paragraph{Soluzione:}

...
Verificare che:
$$ -\frac{1}{4}f(x-h)-\frac{5}{6}f(x)+\frac{3}{2}f(x+h)+\frac{1}{12}f(x+3h)=hf'(x) + O(h^5)$$
\paragraph{Soluzione:}Per prima cosa divido entrambi i membri per h, così ottengo:
$$\frac{-3f(x-h)-10f(x)+18f(x+h)+f(x+3h)}{12h}=f'(x) + O(h^4)$$
...
\begin{equation}
    \begin{aligned}
        &\frac{-3f(x-h)-10f(x)+18f(x+h)+f(x+3h)}{12h}= \\
        &=\frac{(-3-10+18+1)f(x) + (3h+18h+3h)f'(x)+(-\frac{3}{2}h^2+9h^2+\frac{9}{2}h^2)f''(x)}{12h}+ \\
